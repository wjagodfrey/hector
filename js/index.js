...
(function() {
  var entities, events, fireEvent, frame, frameCount, frameIndex, gameCanvas, gameCq, group, groupName, hasMouseHit, loaded, loadedFrameCount, mouse, mouseDownHandler, mouseMoveHandler, mouseUpHandler, onEvent, resizeFactor, root, sprite, spriteName, sprites, touchMove, touchTimeout, _fn, _ref, _ref1,
    __slice = [].slice;

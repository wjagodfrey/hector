...
(function() {
  var entities, events, eyebrowsStates, eyelidsStates, fireEvent, frame, frameCount, frameIndex, gameCanvas, gameCq, getUrlSettings, group, groupName, hasMouseHit, hasTouch, loaded, loadedFrameCount, mouse, mouseDownHandler, mouseMoveHandler, mouseUpHandler, mouthStates, onEvent, pupilsStates, resizeFactor, root, setUrlSettings, sprite, spriteName, sprites, touchDown, touchMove, touchTimeout, _fn, _ref, _ref1,
    __slice = [].slice,
  ...
  hasTouch = __indexOf.call(document.documentElement, 'ontouchstart') >= 0;

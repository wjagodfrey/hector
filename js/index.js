...
(function() {
  ...
  onEvent('assetsLoaded', (function(_this) {
    return function() {
      ...
      return entities.push(root.wallpaper = wallpaper = {
        tile: cq(),
        draw: function(ctx) {
  ...
  onEvent('assetsLoaded', (function(_this) {
    return function() {
      var face;
      return entities.push(root.face = face = {
        x: 0,
        y: 0,
        yOffset: -12,
        focal: {
    ...
    return function() {
      ...
      for (i in btnNames) {
        ...
        _results.push((function(i, name) {
          return entities.push(root.btns[name] = btns[name] = {
            x: 0,
            y: 0,
  ...
  onEvent('assetsLoaded', function() {
    ...
    return entities.push(root.hand = hand = {
      a: {
